...
/// \file nova_fonts.h
/// \brief Р¤Р°Р№Р» СЃ РѕРїРёСЃР°РЅРёРµРёРј РІСЃРµРіРѕ С‡С‚Рѕ РЅСѓР¶РЅРѕ РґР»СЏ РїРѕСЃС‚СЂРѕРµРЅРёСЏ С€СЂРёС„С‚РѕРІ
///
/// РўСѓС‚ Сѓ РЅР°СЃ Р»РµРіРєРёР№ РєРѕРІРµСЂС‚РѕСЂ РєРѕРґРёСЂРѕРІРѕРє (РёРЅС‚РµСЂС„РµР№СЃ iconv) Рё СЂР°СЃС€РёСЂРµРЅРЅР°СЏ СЂРµР°Р»РёР·Р°С†РёСЏ
/// С€СЂРёС„С‚РѕРІ TrueType, СЏ СЂРµС€РёР» СѓР±СЂР°С‚СЊ РІРёРЅ С€СЂРёС„С‚С‹, РѕРЅРё СЃРѕРІСЃРµРј РЅРµ РіРёР±РєРёРµ, Рё РёС…
/// РІСЃРµ СЂР°РІРЅРѕ РЅРёРєС‚Рѕ РЅРµ Р±СѓРґРµС‚ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ. РћСЃС‚Р°РµС‚СЃСЏ С‚РѕР»СЊ РѕРґРёРЅ С‚РёРї С€СЂРёС„С‚РѕРІ
/// FreeType2. Р”СѓРјР°СЋ РІСЃРµ РїРѕР№РјСѓС‚ РїРѕС‡РµРјСѓ СЏ СЃРґРµР»Р°Р» РІС‹Р±РѕСЂ РІ РїРѕР»СЊР·Сѓ СЌС‚РѕР№ Р±РёР±Р»РёРѕС‚РµРєРё)

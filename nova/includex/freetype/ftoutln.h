...
FT_BEGIN_HEADER
  ...
  /*    segments and BГ©zier arcs.  This function is also able to emit      */
  ...
  /*    the outline's points, including BГ©zier control points.  Though it  */
  /*    coincides with the exact bounding box for most glyphs, it can be   */
  /*    slightly larger in some situations (like when rotating an outline  */
  /*    which contains BГ©zier outside arcs).                               */
  /*                                                                       */

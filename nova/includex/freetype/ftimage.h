...
#define ft_pixel_mode_pal4   FT_PIXEL_MODE_GRAY4
 ...
 /* */
  ...
  /*                  point is `off' the curve, i.e., a BГ©zier control     */
  /*                  point, while it is `on' when set.                    */
  /*                                                                       */
  /*                  Bit 1 is meaningful for `off' points only.  If set,  */
  /*                  it indicates a third-order BГ©zier arc control point; */
...
#define  FT_Outline_LineTo_Func  FT_Outline_LineToFunc
  ...
  /*    to' function during outline walking/decomposition.                 */
  /*                                                                       */
  /*    A `conic to' is emitted to indicate a second-order BГ©zier arc in   */
  /*    the outline.                                                       */
  /*                                                                       */
  /* <Input>                                                               */
...
#define  FT_Outline_ConicTo_Func  FT_Outline_ConicToFunc
  ...
  /*    to' function during outline walking/decomposition.                 */
  /*                                                                       */
  /*    A `cubic to' is emitted to indicate a third-order BГ©zier arc.      */
  /*                                                                       */
  /* <Input>                                                               */
  /*    control1 :: A pointer to the first BГ©zier control point.           */
  /*                                                                       */
  /*    control2 :: A pointer to the second BГ©zier control point.          */
  /*                                                                       */
...
#define  FT_Outline_CubicTo_Func  FT_Outline_CubicToFunc
  ...
  /*    decomposition in order to emit segments, conic, and cubic BГ©ziers, */
  ...
  /*                                                                       */
  /*    conic_to :: The second-order BГ©zier arc emitter.                   */
  /*                                                                       */
  /*    cubic_to :: The third-order BГ©zier arc emitter.                    */
  /*                                                                       */
...
#define FT_IMAGE_TAG( value, _x1, _x2, _x3, _x4 )  \
  ...
  /*      and BГ©zier arcs; it can be described as an @FT_Outline; you      */
